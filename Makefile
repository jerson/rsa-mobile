...
binding: deps
	...
	go build -ldflags="-w" -x -o output/binding/rsa.so -buildmode=c-shared binding/main.go

archive: deps
	mkdir -p output/archive
	go build -ldflags="-w" -x -o output/archive/rsa.a -buildmode=c-archive binding/main.go
